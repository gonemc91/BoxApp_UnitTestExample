...
/**
 * Catch the exception throw by the [block] and check the exception type [T].
 * This method fails with [AssertionError] if:
 * -exception type is not a type or subtype of [T]
 * -exception is not thrown be the [block]
 */
...
fun arranged(){
    ...
    // Look for the method annotated with @Before annotation if you se
    // this call
}
